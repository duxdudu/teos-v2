...
export default function LandscapeServices() {
  ...
  const services = [
    {
      icon: Trees,
      title: t('servicesPages.landscape.cards.nature.title'),
      description: t('servicesPages.landscape.cards.nature.description'),
      features: [
        t('servicesPages.landscape.cards.nature.features.0'),
        t('servicesPages.landscape.cards.nature.features.1'),
        t('servicesPages.landscape.cards.nature.features.2'),
        t('servicesPages.landscape.cards.nature.features.3')
      ]
    },
    {
      icon: Waves,
      title: t('servicesPages.landscape.cards.seascapes.title'),
      description: t('servicesPages.landscape.cards.seascapes.description'),
      features: [
        t('servicesPages.landscape.cards.seascapes.features.0'),
        t('servicesPages.landscape.cards.seascapes.features.1'),
        t('servicesPages.landscape.cards.seascapes.features.2'),
        t('servicesPages.landscape.cards.seascapes.features.3')
      ]
    },
    {
      icon: Building2,
      title: t('servicesPages.landscape.cards.cityscapes.title'),
      description: t('servicesPages.landscape.cards.cityscapes.description'),
      features: [
        t('servicesPages.landscape.cards.cityscapes.features.0'),
        t('servicesPages.landscape.cards.cityscapes.features.1'),
        t('servicesPages.landscape.cards.cityscapes.features.2'),
        t('servicesPages.landscape.cards.cityscapes.features.3')
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <header className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm shadow-sm border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center justify-between gap-3 sm:gap-4 py-3 sm:py-0 min-h-16">
            <Link href="/" className="flex items-center space-x-1.5 sm:space-x-2 text-gray-600 hover:text-green-600 transition-colors">
            ...
            <div className="flex items-center space-x-1.5 sm:space-x-2">
              ...
              <h1 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">{t('servicesPages.landscape.title')}</h1>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="text-center text-white max-w-4xl mx-auto px-4">
            <div className="flex items-center justify-center space-x-3 mb-6">
              ...
              <h1 className="text-5xl sm:text-7xl font-bold">
                {t('servicesPages.landscape.title')}
              </h1>
            </div>
            <p className="text-xl sm:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto">
              {t('servicesPages.landscape.heroSubtitle')}
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
              {t('servicesPages.landscape.servicesHeading')}
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              {t('servicesPages.landscape.servicesSubheading')}
            </p>
          </div>
      ...
      <section className="py-20 bg-green-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
              {t('servicesPages.landscape.portfolioHeading')}
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300">
              {t('servicesPages.landscape.portfolioSubheading')}
            </p>
          </div>
      ...
      <LightboxDialog
        images={portfolioImages.map((src, i) => ({ src, alt: `Landscape Photography ${i + 1}` }))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-6">
                {t('servicesPages.landscape.whyHeading')}
              </h2>
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">{t('servicesPages.landscape.why.items.0.title')}</h3>
                    <p className="text-gray-600 dark:text-gray-300">{t('servicesPages.landscape.why.items.0.desc')}</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">{t('servicesPages.landscape.why.items.1.title')}</h3>
                    <p className="text-gray-600 dark:text-gray-300">{t('servicesPages.landscape.why.items.1.desc')}</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">{t('servicesPages.landscape.why.items.2.title')}</h3>
                    <p className="text-gray-600 dark:text-gray-300">{t('servicesPages.landscape.why.items.2.desc')}</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-green-500 to-blue-500">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-white mb-6">
            {t('servicesPages.landscape.ctaHeading')}
          </h2>
          <p className="text-xl text-green-100 mb-8">
            {t('servicesPages.landscape.ctaSubheading')}
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <a 
              href="tel:+212123456789"
